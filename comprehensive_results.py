...
# Read FALCON artifact summary
falcon_file = r"c:\Users\YOGA\Downloads\research\falcon_comprehensive_results_all_projects.csv"
rows = list(csv.DictReader(open(falcon_file, encoding='latin1', newline='')))

num = lambda s: float(re.match(r'\s*([0-9]*\.?[0-9]+)', s).group(1))
...
falcon_variants = ['FALCON-unixcoder-cosine', 'FALCON-unixcoder-euclidean', 
                   'FALCON-codebert-cosine', 'FALCON-graphcodebert-cosine']
