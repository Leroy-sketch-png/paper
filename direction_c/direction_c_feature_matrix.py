...
Input: embeddings/{subject}_embeddings.npy from direction_c/direction_c_compute_embeddings.py
...
def main():
    ...
    if not embeddings:
        print("\nERROR: No embeddings found. Run direction_c/direction_c_compute_embeddings.py first.")
        return
