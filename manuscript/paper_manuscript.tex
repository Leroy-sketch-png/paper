...
\title{\textbf{Label Realism, Data Governance, and Representation Shift: Revisiting ML-Based TCP in Continuous Integration}}
\author{\textbf{1st Author Name}\\Author 1 Affiliation\\City, Country\\author1@example.com\and \textbf{2nd Author Name}\\Author 2 Affiliation\\City, Country\\author2@example.com\and \textbf{3rd Author Name}\\Author 3 Affiliation\\City, Country\\author3@example.com}
\date{May 2026}
\begin{document}
\maketitle
\begin{abstract}
...
\hline
\endhead
Source paper dataset (Zenodo 7036507) & Baseline replication & 11 open-source Java/C & 800 commits $\times$ 11 & Requires Understand + Ranklib \\
\hline
...
\begin{itemize}[leftmargin=*]
\item \textbf{Hypothesis B1:} Federated pretraining retains $\geq$ 70\% of the centralized transfer gain relative to no-pretraining baseline.
